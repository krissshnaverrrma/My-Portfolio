# 🚀 Krishna's Virtual AI Assistant based Portfolio
...
* **Python ATM Simulation**: A robust console application simulating core banking functionalities, including secure PIN verification and state persistence.
...
* **Artificial Intelligence Masterclass** – Udemy (2026).
* **Python ATM Simulation** – Let'sUpgrade (2026).
* **Git - Github Bootcamp** – Let'sUpgrade (2026).
...
* **Quote Studio: AI Meets Minimalism**: A full-stack web application combining AI-generated content with a polished, dark-mode aesthetic.
* **Mastering Time**: A study in asynchronous UI updates and precise main-thread management using Python.
